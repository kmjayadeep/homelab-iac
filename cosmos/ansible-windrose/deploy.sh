...
echo "  Status:        ssh windrose 'cd /home/windrose/windrose-server && ./windrose status'"
echo "  View logs:     ssh windrose 'cd /home/windrose/windrose-server && ./windrose logs'"
echo "  Worlds:        ssh windrose 'cd /home/windrose/windrose-server && ./windrose worlds'"
echo "  Switch world:  ssh -t windrose 'cd /home/windrose/windrose-server && ./windrose switch'"
...
echo "  Backup:        ansible-playbook playbooks/backup.yml"
echo ""
echo "Invite code:"
echo "  ssh windrose 'cat /home/windrose/windrose-server/data/R5/ServerDescription.json'"
echo ""
